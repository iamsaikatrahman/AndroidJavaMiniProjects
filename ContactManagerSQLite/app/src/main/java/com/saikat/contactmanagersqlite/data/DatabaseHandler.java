package com.saikat.contactmanagersqlite.data;
...
import com.saikat.contactmanagersqlite.R;
import com.saikat.contactmanagersqlite.model.Contact;
import com.saikat.contactmanagersqlite.util.Util;
...
//        String selectAll = String.valueOf(R.string.select_from) + Util.TABLE_NAME;
    ...
    //Get contacts count
    public int getCount() {
        String countQuery = String.valueOf(R.string.select_from) + Util.TABLE_NAME;
        SQLiteDatabase db = this.getReadableDatabase();
